...
1. Branch from `main`. Prefer `fix/…`, `docs/…`, `test/…`, `ci/…`, `chore/…`, or `harden/…` for hardening sprints.
...
6. Do not commit commercial verticals here — this repo is the public platform core only.
